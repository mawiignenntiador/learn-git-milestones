...
| `*italicized text*`            | _italicized text_            | `<i>italicized text</i>`                     |
...
1. ✏️ Edit this `README.md` file (click the pencil icon on the Github.com page) and add your _1st_ favorite emoji to the **Completed** column in appropriate row in the [completions [3-1]](#completions) section, below.
...
1. ✏️ In VS Code, edit this README file and add your _2nd_ favorite emoji to [completions [4-1]](#completions) and save the file.
...
```html
<parent-folder>
  <-THIS! |-- first-website |-- learn-git-milestones</parent-folder
>
```
...
1. ✏️ Paste a link to the **_live_** (github.io) website in [completions [7-1]](#completions).
...
| 9   | 6-1  | Link to `first-website` github.com repo page     | https://github.com/mawiignenntiador/first-website                                                                                         |
| 10  | 7-1  | Link to `first-website` github.io "project site" | https://mawiignenntiador.github.io/first-website/                                                                                         |
...
> _A pull request (PR) is the method to move commits from one branch or repo into another branch or repo. This could be used to sync commits across two branches in the same repository or ask another project owner to merge commits from your fork into theirs. Below, you will use a PR to sync changes from your new branch to the `main` branch._
